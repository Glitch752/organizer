...
import { TaskStateTag } from "./customTags";

// Adapted from https://github.com/silverbulletmd/silverbullet/blob/main/web/markdown_parser/extended_task.ts
// ...which is adapted from https://github.com/lezer-parser/markdown/blob/main/src/extension.ts
